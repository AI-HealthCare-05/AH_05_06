# 팀원 Jira-GitHub 아이디 매핑

PR 본문·코멘트에서 리뷰어를 멘션할 때는 기억이나 추측으로 아이디를 적지 말고 이 표를 확인한다.
...
* 팀원 GitHub 아이디가 바뀌면 이 표를 먼저 수정한 뒤 PR·코멘트에서 사용한다.
* PR 본문에 리뷰어를 적을 때는 이 표의 아이디를 그대로 복사해서 쓴다.
