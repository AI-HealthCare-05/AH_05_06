    ...
    guide: {
      ...
      goals: [
        { n:'LH / FSH 비율', a:'3.2', now:'2.4', t:'2.0', hasChart:true,
          rangeLabel:'목표를 가운데 두고 본 지금 값',
          startLine:'시작 3.2 · 지금 2.4', targetLabel:'목표 2.0',
          nowPct:'44%', tPct:'50%', startPct:'38%' },
        { n:'DHEA-S',        a:'260', now:'210', t:'200', hasChart:true,
          rangeLabel:'목표를 가운데 두고 본 지금 값',
          startLine:'시작 260 · 지금 210', targetLabel:'목표 200',
          nowPct:'44%', tPct:'50%', startPct:'38%' },
