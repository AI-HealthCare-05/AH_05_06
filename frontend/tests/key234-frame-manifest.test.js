...
/* **대상을 여기에 적어 둔다.** 「needsGuideScreen 으로 거른 것이
   ...
   지금 24개다. 팀 계획 문서(`docs/work-packages.md`)는 20으로 적혀 있는데,
   그 숫자는 구조 진단 §6.2 의 **목표치**(완전 36 · 조회 8 · 안내 20)에서 왔고
   현재 상태로 다시 세면 24다. 문서 쪽을 고쳐야 한다.

   D2-3(처방 설정)이 여기서 빠졌다 — `settings.html` 이 생겨 안내할 자리가
   아니라 쓰는 자리가 됐다. 이렇게 하나씩 줄어드는 것이 맞다. */
