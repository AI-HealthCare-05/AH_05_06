...
var FRAMES = [
  ...
  {"id": "D2-2", "area": "medic", "name": "안내문 고치기 — 원본 ↔ 원장님 문구", "level": 2, "target": 1, "url": "/settings.html", "blocker": "미리보기가 없다 — 고친 글이 안내문에서 어떻게 보이는지 이 화면에서 못 본다 (KEY-258). 생성이 읽는 것은 KEY-243 이 이었다"},
  ...
  {"id": "P1-1", "area": "patient", "name": "링크로 들어옴 — 인증번호 보내기", "level": 3, "target": 1, "blocker": "실제 문자 발송기가 없다 — 고정 OTP 좁은문(MOCK_OTP_CODE)이 열렸을 때만 인증번호가 나간다. 진입 화면도 없음", "role": "안내문 링크로 들어와 인증번호를 받는다"},
