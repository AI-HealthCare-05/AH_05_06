...
async def test_redis_enqueue_failure_returns_failed_status(
    ...
    monkeypatch.setattr(OcrJobDocument, "filter", staticmethod(lambda **_: _DeleteQS()))
    monkeypatch.setattr(OcrJob, "filter", staticmethod(lambda **_: _DeleteQS()))
    monkeypatch.setattr(MedicalDocument, "filter", staticmethod(lambda **_: _DeleteQS()))
